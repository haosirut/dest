...
#[tauri::command]
pub async fn debug_log(app: AppHandle, message: String) -> Result<(), String> {
...
#[tauri::command]
pub async fn get_debug_log_path(app: AppHandle) -> Result<Option<String>, String> {
...
#[tauri::command]
pub async fn discover_local_peers() -> Result<Vec<DiscoveredPeer>, String> {
